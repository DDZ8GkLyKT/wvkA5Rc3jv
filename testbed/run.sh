...
function show_demo
{
    ...
    run_experiment
    echo "Demo Started"
    ~/go/bin/grafana-rrd-server -r data/ -s 1 -p 9001 &
    grafana_pid="$!"
    ./telematics/telematics log -duration 7200 -display -num_shards 10 -grafana -targetfile godump.txt &
    telematics_pid="$!"
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_0.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_1.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_2.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_3.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_4.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_5.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_6.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_7.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_8.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_9.txt -targetfile godump2.txt &
    ./telematics/telematics log -duration 7200 -nodelist shard_nodes/shard_10.txt -targetfile godump2.txt &
    #telematics_1_pid="$!"
    wait $grafana_pid
    wait $telematics_pid	   
}
