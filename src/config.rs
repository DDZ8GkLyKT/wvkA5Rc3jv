...
pub const TX_THROUGHPUT: u32 = 150000; // the transaction throughput we want to support (in Tx/s)
...
pub const FOREIGN_BLOCKS_PER_SHARD: u32 = 1000;
...
lazy_static! {
    ...
    pub static ref SHARD_ID: AtomicU32 = AtomicU32::new(0);
    pub static ref NUM_SHARDS: AtomicU32 = AtomicU32::new(0);
