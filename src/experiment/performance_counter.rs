...
pub struct Counter {
    ...
    confirmed_shard_transactions: AtomicUsize,
...
pub struct Snapshot {
    ...
    pub confirmed_shard_transactions: usize,
...
impl Counter {
    pub fn new() -> Self {
        return Self {
            ...
            confirmed_shard_transactions: AtomicUsize::new(0),
    ...
    pub fn record_confirm_shard_transaction(&self, t: &Transaction) {
        self.confirmed_shard_transactions.fetch_add(1, Ordering::Relaxed);
    }
    ...
    pub fn snapshot(&self) -> Snapshot {
        ...
        return Snapshot {
            ...
            confirmed_shard_transactions: self.confirmed_shard_transactions.load(Ordering::Relaxed),
