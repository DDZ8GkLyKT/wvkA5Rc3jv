...
pub struct Content {
    ...
    pub transaction_refs: Vec<(u32,H256)>,
...
impl Content {
    ...
    pub fn new(transaction_refs: Vec<(u32,H256)>, proposer_refs: Vec<H256>) -> Self {
        Self {
            transaction_refs,
            proposer_refs,
        }
...
pub fn genesis() -> Block {
    ...
    return Block::new(
        ...
        all_zero,
        *DEFAULT_DIFFICULTY,
        1, //No need to update to correct shard_id here since the shard_id only matters for transaction blocks
    );
}
